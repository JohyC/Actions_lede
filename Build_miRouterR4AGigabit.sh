...
git clone https://github.com/walkingsky/luci-wifidog.git && mv luci-wifidog luci-app-wifidog && mv luci-app-wifidog /workdir/openwrt/package/feeds/luci/luci-app-wifidog
